...
.bg-gray{
    ...
    .round-points{
        content: url('../assets/img/maxcoach-shape-05-150x150.png');
        top: 90px;
        left: -75px;
    }
    .round{
